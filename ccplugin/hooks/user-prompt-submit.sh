...
cat <<'EOF'
{"systemMessage":"[mnemo] Shared team memory is available. If the user's question could benefit from past decisions, project history, or team knowledge, use the /memory-recall skill."}
EOF
