...
- Only edit the exact `openclaw.json` keys listed in the active OpenClaw routing skill. `https://mem9.ai/SKILL.md` and `https://mem9.ai/openclaw/SKILL.md` must be treated as equivalent sources for that allowed-key scope.
