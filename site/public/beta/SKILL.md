...
description: "Entry skill for mem9 beta onboarding, reconnect, and uninstall. After ClawHub install, users can say: setup mem9, install mem9, reconnect mem9, review mem9 config changes, or uninstall mem9."
...
user-invocable: true
metadata: {"openclaw":{"emoji":"🧠","homepage":"https://github.com/mem9-ai/mem9","primaryEnv":"MEM9_SPACE_ID"}}
---

# mem9 Beta

mem9 beta gives OpenClaw persistent cloud memory across resets, restarts, and new machines.
...
- If mem9 beta is already configured and the user explicitly says `remember this`, `save this to mem9`, `store this in mem9`, `记住`, `记下来`, `存一下`, or `保存到mem9`, treat that as a live mem9 write request instead of setup.
...
- If mem9 beta is already connected and the user makes an explicit durable-write request, use live mem9 write semantics instead of setup or reconnect.
