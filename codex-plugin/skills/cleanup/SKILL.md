...
`run` removes `$CODEX_HOME/mem9/install.json`, `$CODEX_HOME/mem9/config.json`, and `$CODEX_HOME/mem9/state.json`, plus legacy mem9 entries from `$CODEX_HOME/hooks.json` and the legacy `$CODEX_HOME/mem9/hooks/` shim directory.
