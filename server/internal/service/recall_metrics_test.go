...
func TestObserveRecallAutoEmbeddingRequestUsesAutoModel(t *testing.T) {
	...
	observeRecallAutoEmbeddingRequest("tidbcloud_free/amazon/titan-embed-text-v2", nil, false)
...
func TestObserveRecallAutoEmbeddingRequestTracksErrors(t *testing.T) {
	...
	observeRecallAutoEmbeddingRequest("tidbcloud_free/amazon/titan-embed-text-v2", errors.New("boom"), false)
