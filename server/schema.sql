...
CREATE TABLE IF NOT EXISTS session_edits (
  ...
  edited_content   MEDIUMTEXT      NOT NULL COMMENT 'Post-edit content; empty string = no content override (mark-only row)',
  edited_tags      JSON            NULL     COMMENT 'NULL = no tag override; non-NULL (incl. []) overrides',
  correctness      VARCHAR(20)     NULL     COMMENT 'Review mark: correct|incorrect; NULL = unmarked. A content edit auto-sets correct',
