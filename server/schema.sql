...
-- The vector index is created at server startup via Go bootstrap code
-- (EnsurePrototypeVectorIndex) with duplicate-index error handling.
-- Do NOT add an ALTER TABLE here; it is not safe to rerun.
